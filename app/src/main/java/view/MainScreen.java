...
public final class MainScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPanelTasks.setEnabled(false);
    ...
    private void showJtableTasks(boolean hasTasks) {
        ...
        if (hasTasks) {
            ...
            jPanel7.add(jScrollPanelTasks);
            jScrollPanelTasks.setVisible(true);
            jScrollPanelTasks.setSize(jPanel7.getWidth(), jPanel7.getHeight());
        } else {
            if (jScrollPanelTasks.isVisible()) {

                jScrollPanelTasks.setVisible(false);
                jPanel7.remove(jScrollPanelTasks);
            }
